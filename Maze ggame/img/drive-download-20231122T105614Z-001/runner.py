...
pygame.display.set_caption("Kelompok 9")
...
chara = pygame.image.load("assets/images/character.png")
chara = pygame.transform.scale(chara, (width-150, height/3))
